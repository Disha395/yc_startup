...
export default function Page() {
  ...
  useEffect(() => {
    Sentry.captureMessage("Connectivity test message");
  }, []);
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://jsmastery-mj.sentry.io/issues/?project=4509477346541568">Issues Page</a>.
